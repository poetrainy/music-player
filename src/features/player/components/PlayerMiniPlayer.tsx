...
export function PlayerMiniPlayer() {
  ...
  return (
    <div className="bg-surface-elevated border-foreground/10 fixed inset-x-0 bottom-0 z-50 flex items-center gap-3 border-t px-4 py-2">
      <Link
      ...
      {hasAdjacentSong ? (
        <button type="button" onClick={playNext} className="text-foreground">
