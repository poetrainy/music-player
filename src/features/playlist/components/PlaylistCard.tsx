...
export function PlaylistCard({ playlist }: Props) {
  return (
    <Link href={`/playlists/${playlist.id}`}>
      <div className="hover:bg-surface-elevated flex items-center gap-3 rounded-md px-2 py-2 sm:hidden">
      ...
      <div className="hover:bg-surface-elevated hidden rounded-lg p-3 transition-colors sm:flex sm:flex-col sm:gap-3">
